export default function PrivacyPolicyPage() {
  return (
    <div className="container mx-auto bg-white dark:bg-gray-800 ml:p-8 rounded-lg text-lg p-2">
      ...
      <div className="mb-6">
        <h3 className=" font-bold mb-4">1. Mục đích và phạm vi thu thập</h3>
        <p className=" mb-4 text-lg">
          Việc thu thập dữ liệu người tiêu dùng trên website Fleurs bao gồm:
          email, điện thoại, địa chỉ khách hàng. Đây là các thông tin mà
          Fleurs cần khách hàng cung cấp bắt buộc khi sử dụng dịch vụ và để
          Fleurs liên hệ xác nhận khi khách hàng đăng ký sử dụng dịch vụ trên
      ...
      <div className="mb-6">
        <h3 className="font-bold mb-4">2. Phạm vi sử dụng thông tin</h3>
        <p className=" mb-4 text-lg">
        ...
        <ul className="list-disc list-inside ">
          ...
          <li>
            ...
            nhận và liên hệ có liên quan đến giao dịch tại Fleurs;
          </li>
          <li>
      ...
      <div className="mb-6">
        <h3 className="font-bold mb-4">3. Thời gian lưu trữ thông tin</h3>
        <p className="text-lg">
          Dữ liệu cá nhân của khách hàng sẽ được lưu trữ cho đến khi có yêu cầu
          hủy bỏ hoặc khách hàng yêu cầu hủy bỏ. Còn lại trong mọi trường hợp
          thông tin cá nhân khách hàng sẽ được bảo mật trên máy chủ của
          Fleurs.
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="text-lg">
          Cửa hàng chuyên kinh doanh các sản phẩm nước hoa 
        </p>
        <p className="text-lg">
      ...
      <div className="mb-6">
        ...
        <ul className="list-disc list-inside ">
          ...
          <li>
            ...
            bên thứ 3 đến quản trị website khuyến mại Fleurs. Khi tiếp nhận
            những phản hồi này, chúng tôi sẽ xác nhận lại thông tin, trường hợp
            đúng như phản ánh của thành viên tùy theo mức độ, chúng tôi sẽ có
      ...
      <div className="mb-6">
        ...
        <p className="text-lg mb-4">
          Thông tin cá nhân của khách hàng tại Fleurs được cam kết bảo mật
          tuyệt đối theo chính sách bảo vệ thông tin cá nhân của Fleurs. Việc
          thu thập và sử dụng thông tin của mỗi khách hàng chỉ được thực hiện
        ...
        <ul className="list-disc list-inside ">
          ...
          <li>
            ...
            bao gồm thông tin hóa đơn kế toán chứng từ số hóa trên
            fleurs.com.
          </li>
        </ul>
      </div>
